...
public class Session22_Howtouploadfiles {
	...
	public static void main(String[] args) throws FindFailed {
		...
		String openbutton = "C:\\Users\\jatin\\Desktop\\Sikuli\\openbuttton2.png";
		...
		Pattern open=new Pattern(openbutton);
		Pattern file=new Pattern(inputfilepath);
		
	Screen src=new Screen();
	src.type(file, "J:\\jatin updated resume.pdf");
	src.click(open);
