...
public class Rumpropertyfile {
	...
	public static void main(String[] args) throws IOException {
		...
		//fileinputstream humne property file ki location dene k liye kiya hai.
	...
	System.setProperty(prop.getProperty("Driver"), "J:\\eclipse_Jdrive\\JavaSelenium\\src\\test\\java\\PropertyFile\\chromedriver.exe");  
	//prop.getproperty class is used here to get property of the key from property file.
	//jo bhi key property file me diya hua hai uski value ko access karne k liye prop.getproperty key ka use karna hoga.
